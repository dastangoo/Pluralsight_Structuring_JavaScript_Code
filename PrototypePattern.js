...
Calculator.prototype = {
	...
	setOperator: function(newOperator){
		...
		this.lastNumber = parseFloat(this.eqCtl.innerHTML);
	...
	numberClick: function(e){
		...
		this.setValue(this.currNumberCtl.innerHTML + button.innerHTML);
	...
	calculate: function(){
		...
		var displayedNumber = parseFloat(this.currNumberCtl.innerHTML), newVal = 0;
		//eval() would've made this a whole lot simpler
		//but didn't want to use it in favor of more
